...
% First give an overall view of how the code works
% Email id extraction
% Email date extraction
% Email subject extraction
% Email Body extraction
%Generating the output and how to run the code.
% Scalability and time taken
% Validation experiments. - Mention how to run check data integrity and the remaining part.

% Email date extraction
% Date extraction example. How the timezones are handled.
...
% How the message part works - example mail and example output. after filtering after various steps. 

 
% Basically writing to the pickle file.. What all is present in pickle file..

% Then the filtering logic.


% How to run the entire code documentation.

% What the code doesn't handle - Limitatiosn - Mapping email ids limitation and Email address construction limitation.
